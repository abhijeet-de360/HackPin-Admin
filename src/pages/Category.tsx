          ...
          <Table>
            <TableHeader>
              <TableRow>
                ...
                <TableHead className="w-40">Like</TableHead>
                <TableHead className="w-24">Comment</TableHead>
                <TableHead className="w-32 text-center">Share</TableHead>
                {/* <TableHead className="w-32 text-center">Total Due</TableHead> */}
              </TableRow>
            </TableHeader>
            <TableBody>
              {visibleCustomers.map((customer) => {
                ...
                return (
                  <TableRow key={customer.id}>
                    ...
                    <TableCell>CT-011</TableCell>
                    <TableCell>Sports</TableCell>
                    <TableCell>13000</TableCell>
                    <TableCell>941</TableCell>
                    ...
                    {/* <TableCell className="text-center">
                      <span
                        className={stats.totalDue > 0 ? "text-orange-600" : ""}
                      >
                        ₹{stats.totalDue.toFixed(2)}
                      </span>
                    </TableCell> */}
